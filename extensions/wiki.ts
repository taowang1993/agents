...
- Before creating docs, check for existing documentation (README.md, docs/, openwiki/) and adapt it instead of starting from scratch.
...
Important: read existing documentation first — README.md, docs/, openwiki/, or any other doc directories — and adapt them into ${WIKI_DIR}. Do not rewrite from zero if good docs already exist.
