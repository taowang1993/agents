...
| `/private/var/folders/.../X/com.microsoft.edgemac.code_sign_clone` | Microsoft Edge code-signing/app bundle clones. Removed 8.9GB on 2026-06-21. Found 6 active clones totaling 5.3GB on 2026-07-07. | Quit Edge with AppleScript, confirm `lsof +D` is empty, then `rm -rf` only this folder. |
