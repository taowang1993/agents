...
Use this checklist when generating or reviewing tests for React components.
...
- [ ] **DO NOT mock base components** unnecessarily
- [ ] `vi.clearAllMocks()` in `beforeEach` (not `afterEach`)
- [ ] Shared mock state reset in `beforeEach`
- [ ] i18n uses global mock or is properly mocked
- [ ] Router mocks match actual routing library used in project
...
- [ ] Run `pnpm test path/to/file.spec.tsx` (or `yarn test`) - **MUST PASS before next file**
