...
This guide addresses **multi-file workflow** (how to process multiple test files). For coverage requirements within a single test file, see the Coverage Goals section.
...
### 🔴 Very Complex Components (Many dependencies)
