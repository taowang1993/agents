...
3. Write a report documenting OpenClaw implementations that are valuable to Tockbot's skill system.

4. Write a plan covering those implementations. Then, implement the plan.

5. Update `.agents/reference/skill.md` if needed.
